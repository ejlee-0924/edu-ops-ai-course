...
MCP는 AI가 자료를 찾으러 가는 길입니다. 수강생에게는 먼저 "자료 연결"이라고 설명하고, MCP는 그 연결 방식의 이름이라고 덧붙입니다.
...
- 처음 실습할 때는 샘플 데이터로 진행하고, 실제 업무 자료는 흐름을 이해한 뒤 `private-data/`에 넣습니다.

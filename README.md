...
- 실습 패키지: `practice/` 안의 실습 프롬프트, 템플릿, 백업용 샘플 자료
...
3. 내 업무 Skill로 시작하기: 실제 반복 업무 하나 고르기
4. Clarify 질문으로 구조화하기: Ask Your Question 방식으로 의뢰서 만들기
5. Google Sheets 자료 연결(MCP): 내 업무 시트를 AI가 볼 수 있게 연결하기
6. 첫 결과물 만들기: 내 자료로 리포트, 할 일, 메일 초안 만들기
7. 나만의 업무 레시피 만들기: 잘 된 흐름을 개인용 Skill 초안으로 저장하기

...
```text
이 GitHub 링크에서 실습 자료를 받아서 설치하고, README를 읽은 뒤 교육 운영자 실습을 4번 MCP부터 순서대로 진행해줘:
...
```text
이 폴더의 README를 읽고, 교육 운영자 실습을 4번 MCP부터 순서대로 진행해줘.
```
...
```text
이 practice 폴더의 README를 읽고, 4번 MCP부터 실습을 진행해줘.
```

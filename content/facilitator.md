...
1. 처음에는 반드시 샘플 Google Sheet로 시작합니다.
...
5. Clarify는 완성형 예시를 먼저 사용합니다.
6. 실데이터 적용은 마지막에 선택 과제로 둡니다.
...
> 오늘은 샘플 Google Sheet로 흐름을 익힙니다. 실제 자료는 나중에 내 Google Sheet로 바꿔 같은 방식으로 다시 실행하면 됩니다.
